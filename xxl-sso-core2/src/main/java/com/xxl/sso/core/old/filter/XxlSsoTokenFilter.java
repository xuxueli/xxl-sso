...
//import com.xxl.sso.core.old.entity.ReturnT;
...
//            res.setStatus(HttpServletResponse.SC_OK);
//            res.setContentType("application/json;charset=UTF-8");
//            res.getWriter().println("{\"code\":"+ Const.SSO_LOGIN_FAIL_RESULT.getCode()+", \"msg\":\""+ Const.SSO_LOGIN_FAIL_RESULT.getMsg() +"\"}");
//            return;
//        }
//
//        // ser sso user
//        request.setAttribute(Const.SSO_USER, xxlUser);
//
//
//        // already login, allow
//        chain.doFilter(request, response);
